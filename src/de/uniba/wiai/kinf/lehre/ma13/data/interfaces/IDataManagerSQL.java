...
/**
 * interface for SQL based Datamanger implementations. ensures every datamanger supports the given methods.
 * @author denis
 *
 */
public interface IDataManagerSQL {
	...
	/**
	 * diposes the current Datamaner, closes everything, frees the file to ensure proper GC handling
	 */
	public void dispose();
	
	/**
	 * executes a sql select command
	 * @param SQLString - the SQL String of the select query to be executed
	 ...
	 * @param SQLString - - the SQL String of the query to be executed
	 * @throws SQLException
	 */
