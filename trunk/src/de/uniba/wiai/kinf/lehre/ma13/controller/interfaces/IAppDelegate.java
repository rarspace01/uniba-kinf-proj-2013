...
public interface IAppDelegate
{
	 ...
	 * load all needed instances for functioning
	 * 
	...
	/**
	 * initialise the main window and load up
	 * the given project.
	 */
	...
	/**
	 * Strategy-Pattern: set the mouse-action which handles
	 * mouse events on the canvas
	 */
	public void setMouseAction(MouseAction ma);
	/**
	 * Strategy-Pattern: get the mouse-action object which handles
	 * mouse events on the canvas
	 */
